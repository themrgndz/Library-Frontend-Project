    ...
    <div id="editProfile">
      <form action="/profile/update" method="POST" enctype="multipart/form-data">
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="firstNameInput" name="firstName" defaultValue="..." required />
        </div>

        <div className="mb-3">
          <label htmlFor="lastNameInput" className="form-label">Surname</label>
          <input type="text" className="form-control" id="lastNameInput" name="lastName" defaultValue="..." required />
        </div>
